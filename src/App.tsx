        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {reviews.map((rev, i) => (
            <motion.div 
              ...
              className="gold-block-ring p-10 relative group"
            >
              <div className="flex text-lavie-gold mb-6">
                {[...Array(rev.stars)].map((_, i) => <Star key={i} className="w-3 h-3 fill-current" />)}
              </div>
              <p className="text-lavie-navy/70 italic text-sm leading-relaxed mb-8">"{rev.text}"</p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="lg:grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <a 
              href="#localizacao" 
              className="bg-lavie-navy text-lavie-gold px-10 py-4 rounded-full font-black uppercase text-[10px] tracking-widest hover:bg-lavie-navy/90 transition-all shadow-xl shadow-lavie-navy/20"
            >
              Ver Unidade
            </a>
          </motion.div>
...
const InstagramFeed = () => {
  const images = [
    "https://res.cloudinary.com/dqukldtq1/image/upload/v1777837097/WhatsApp_Image_2026-05-03_at_4.24.47_PM_tnmndy.jpg",
    "https://res.cloudinary.com/dqukldtq1/image/upload/v1777837097/WhatsApp_Image_2026-05-03_at_4.24.47_PM_2_jay3k5.jpg",
    "https://res.cloudinary.com/dqukldtq1/image/upload/v1777837097/WhatsApp_Image_2026-05-03_at_4.24.47_PM_1_g7elfz.jpg",
    "https://res.cloudinary.com/dqukldtq1/image/upload/v1777837096/WhatsApp_Image_2026-05-03_at_4.24.48_PM_1_ehc1dd.jpg",
    "https://res.cloudinary.com/dqukldtq1/image/upload/v1777837096/WhatsApp_Image_2026-05-03_at_4.24.48_PM_fgyfd3.jpg",
        ...
        <div className="lg:grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            <div className="gold-block-ring overflow-hidden group">
              <img 
                src="https://res.cloudinary.com/dqukldtq1/image/upload/v1777835507/WhatsApp_Image_2026-05-03_at_4.06.48_PM_ym0gzx.jpg" 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((cat, i) => (
            <motion.div 
              key={i}
              whileHover={{ y: -10 }}
              className="gold-block-ring p-10 group"
            >
              <div className={`w-12 h-12 flex items-center justify-center mb-8 border border-lavie-gold/20 text-lavie-gold group-hover:bg-lavie-gold group-hover:text-white transition-all rounded-full overflow-hidden shadow-inner`}>
                {cat.icon}
              </div>
              <h4 className="font-serif text-2xl font-bold text-lavie-navy mb-4 group-hover:text-lavie-gold transition-colors">{cat.title}</h4>
              <p className="text-lavie-navy/60 text-sm leading-relaxed">
                {cat.desc}
              </p>
            </motion.div>
          ))}
